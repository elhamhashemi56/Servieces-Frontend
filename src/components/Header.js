    ...
    return(
        <div className='Header-container'>
            <div className='Header-container__left'>
                <img src={logo}></img>
                <Link className='Header-container__left--special'><span className='Header-container__left--specialSpan'>Specialist registration</span></Link>
                <Link className='Header-container__left--home' to='./home'><span className='Header-container__left--homeSpan'>Home</span></Link>
            </div>
