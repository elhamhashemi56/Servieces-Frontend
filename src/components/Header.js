import './header.css'
import logo from './images/logo-oben.png'
    ...
    return(
        <div className='Header-container'>
           <div className='left-header'>
               <div><img src={logo} className='imglogo'></img></div>
               <Link className='special'><span className='specialSpan'>Specialist registration</span></Link> 
               <Link className='special'><span className='specialSpan'>Specialist registration</span></Link>   
           </div>
            <div className='right-header'>
                <div>
                    <form class="d-flex flexextre">
                ...
                <div>
                    <svg className='svgclass' data-bbox="0 0 50 50" data-type="shape" xmlns="http://www.w3.org/2000/svg"
                        width="50" height="50" viewBox="0 0 50 50"><g>
